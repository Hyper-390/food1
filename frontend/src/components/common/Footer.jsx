        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <div className="flex space-x-2">
              <img src="https://via.placeholder.com/120x40/333/fff?text=App+Store" alt="App Store" className="h-8" />
              <img src="https://via.placeholder.com/120x40/333/fff?text=Play+Store" alt="Google Play" className="h-8" />
            </div>
          </div>
        </div>
      </div>
